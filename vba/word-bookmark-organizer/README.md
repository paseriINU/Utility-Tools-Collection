...
- **PDF出力**: しおり付きPDFを元のWord文書と同じフォルダに自動保存
- **ファイル選択**: ダイアログから処理対象のWord文書を簡単に選択
...
2. シート上の「Word しおり整理 & PDF出力」ボタンをクリック
3. ファイル選択ダイアログでWord文書（.docx または .doc）を選択
4. 処理完了まで待機（進捗はイミディエイトウィンドウで確認可能）
5. 完了メッセージが表示されたら、出力先フォルダでPDFを確認
...
=========================================
Word文書のしおり整理を開始します
対象ファイル: C:\Documents\sample.docx
=========================================
[1] はじめに
[2] 背景
[2] 目的
...
=========================================
PDFをエクスポートしています...
PDFを出力しました: C:\Documents\sample.pdf
=========================================
処理完了: 8 個の見出しを処理しました
=========================================
```
...
- **元のWord文書を上書き保存**: アウトラインレベル設定後、元のWord文書が保存されます。必要に応じて事前にバックアップを取ってください。
- **PDF上書き**: 同名のPDFファイルが既に存在する場合、警告なく上書きされます。
