...
| No | 旧行番号 | 新行番号 | 差異タイプ | 旧ファイルのテキスト | 新ファイルのテキスト | 旧スタイル | 新スタイル | 旧ファイル | 新ファイル |
|----|----------|----------|------------|----------------------|----------------------|------------|------------|------------|------------|
| 1 | 5 | 6 | 変更 | 古いテキスト | 新しいテキスト | [標準] ... | [標準] ... | [開く] | [開く] |
| 2 | - | 10 | 追加 | | 追加されたテキスト | | [標準] ... | - | [開く] |
| 3 | 15 | - | 削除 | 削除されたテキスト | | [標準] ... | | [開く] | - |
| 4 | 20 | 21 | スタイル変更 | 同じテキスト | 同じテキスト | [標準] 10pt | [見出し1] 14pt | [開く] | [開く] |

**WinMerge方式の利点：**
- 旧行番号と新行番号が分離表示されるため、どの行が対応するか明確
- 追加された行は旧行番号が「-」、削除された行は新行番号が「-」
- 1行追加/削除しても、以降の行が全部ずれて表示されない
- 「開く」リンクをクリックすると、該当のWordファイルを直接開ける
