Attribute VB_Name = "JRM_Setup"
Option Explicit

'==============================================================================
' JP1 REST ジョブ管理ツール - セットアップモジュール
' シート作成・フォーマット処理
' ※このモジュールは初期化後に削除可能
'==============================================================================
...
Private Sub AddButton(ws As Worksheet, left As Double, top As Double, _
                      width As Double, height As Double, _
                      macroName As String, caption As String, _
                      Optional fillColor As Long = -1)
    ' 図形ボタンを追加（固定サイズ・色付き）
    Dim shp As Shape
