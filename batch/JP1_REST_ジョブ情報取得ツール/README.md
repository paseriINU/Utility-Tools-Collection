...
- 例: `【ジョブ実行結果】【20250106_143028実行分】Job1_テストジョブ.txt`
...
- **文字コード**: Shift-JIS
- **ファイル名**: `【ジョブ実行結果】【yyyyMMdd_HHmmss実行分】ジョブ名_コメント.txt`
  - 例: `【ジョブ実行結果】【20250106_143028実行分】Job1_テストジョブ.txt`
...
```
OUTPUT_FILE:C:\JP1\Output\【ジョブ実行結果】【20250106_143028実行分】Job1_テスト.txt
```
