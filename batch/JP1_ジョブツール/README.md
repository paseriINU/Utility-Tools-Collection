...
4. **ログ取得** - 2つのジョブの標準出力を取得しテキストファイルに出力
...
[OK] ジョブ1のログを出力しました: C:\path\to\job1_log.txt

[ジョブ2] /main_unit/jobgroup1/test_batch/job2

  標準出力ファイル: D:\JP1\spool\stdout_12346.txt
[OK] ジョブ2のログを出力しました: C:\path\to\job2_log.txt
...
| `OUTPUT_DIR` | ログ出力先フォルダ | `%~dp0`（バッチファイルと同じ場所） |
